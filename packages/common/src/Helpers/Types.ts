...
type SkipFirst<T extends any[], N extends number> =
    TupleSplit<T, N>[1];
export type ReplaceInTupleStart<T extends any[], B extends number, R extends any> = NumberEqual<B, 0> extends True ? [R, ...DropFirstInTuple<T>] : ReplaceInTupleStart2<T, B, TakeFirst<T, 1>, R, SkipFirst<T, 1>>;
type ReplaceInTupleStart2<T extends any[], B extends number, C extends any[], R extends any, D extends any[]> = NumberEqual<B, LengthOfTuple<C>> extends True ? [...C, R, ...DropFirstInTuple<D>] : ReplaceInTupleStart2<T, B, TakeFirst<T, Add<LengthOfTuple<C>,1>>, R, SkipFirst<T, Add<LengthOfTuple<C>,1>>>